...
import ecs.models.BigCharacteristicSet;
import ecs.models.BigExtendedCharacteristicSet;
...
/**
 * @author 杨帆玉
 * @date 2020/1/6 8:33 下午
 */
public class DataMap {

    public Map<String, Integer> propertiesSet = new THashMap<String, Integer>();
    public Map<String, Integer> intMap = new THashMap<String, Integer>();

    private DB db;

    public DataMap() {
        this.db = DBMaker.memoryDirectDB()
                .transactionDisable()
    ...
    public void init(Set<RDFTriple> input) {
...
//        System.out.println("****DB");
        ...
        Map<Integer, Integer> dbECSMap = db.hashMapCreate("dbECSMap")
                .keySerializer(Serializer.INTEGER)
                .valueSerializer(Serializer.INTEGER)
                .makeOrGet();
        dbECSMap.clear();
        ...
        eee = System.currentTimeMillis();
        System.out.println("时间: " + (eee - sss));
//        System.out.println(intMap.toString());
//        System.out.println(propertiesSet.toString());
        long end = System.currentTimeMillis();
        System.out.println("DB初始化个数: " + triplesParsed);
...
//        Map<String, Integer> intMapDB = db.createTreeMap("intMap")
